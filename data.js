...
window.MENU = [
  ...
  },
  {
    ...
    items: [
      // NOTE: nutrition values are estimates; almond croissant & muffin ingredients still placeholders.
      { name: 'Plain Croissant',   ingr: 'handcrafted flaky pastry, real French butter', price: 3.00, color: '#C68A3E', img: 'assets/drinks/bake-plain-croissant.png?v=6',
      ...
      { name: 'Cinnamon Roll',     ingr: 'soft dough, swirled cinnamon, rich vanilla glaze', price: 4.50, color: '#8B5A2B', img: 'assets/drinks/bake-cinnamon-roll.png?v=6',
