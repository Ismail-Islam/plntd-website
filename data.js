...
window.MENU = [
  {
    ...
    items: [
      { name: 'Green Glow',         ingr: 'apple, spinach, avocado, broccoli, lemon, coconut water', price: 6.50, color: '#3E7A1E', img: 'assets/drinks/smoothie-green-glow.png?v=20260710',
        allergens: ['Coconut'], nutrition: { kj: 720, kcal: 172, fat: 8, satFat: 1.2, carbs: 18, sugars: 12, fibre: 5, protein: 3, sodium: 25 } },
      { name: 'Green Machine',      ingr: 'kale, spinach, cucumber, apple, ginger, lemon, coconut water', price: 6.50, color: '#3E7A1E', img: 'assets/drinks/smoothie-green-machine.png?v=20260710',
        allergens: ['Coconut'], nutrition: { kj: 380, kcal: 90, fat: 0.6, satFat: 0.1, carbs: 22, sugars: 14, fibre: 4, protein: 2, sodium: 35 } },
      { name: 'Pineapple Sunrise',  ingr: 'pineapple, banana, apple, coconut water', price: 6.50, color: '#DF9A00', img: 'assets/drinks/smoothie-pineapple-sunrise.png?v=20260710',
        allergens: ['Coconut'], nutrition: { kj: 760, kcal: 180, fat: 0.6, satFat: 0.1, carbs: 44, sugars: 32, fibre: 4, protein: 2, sodium: 10 } },
      { name: 'Blueberry Breeze',   ingr: 'blueberries, banana, almond milk', price: 6.50, color: '#2E0096', img: 'assets/drinks/smoothie-blueberry-breeze.png?v=20260710',
        allergens: ['Tree nuts (almond)'], nutrition: { kj: 840, kcal: 200, fat: 4, satFat: 0.3, carbs: 39, sugars: 28, fibre: 4, protein: 3, sodium: 70 } },
      { name: 'Strawberry Delight', ingr: 'strawberries, apple, coconut water', price: 6.50, color: '#C1002F', img: 'assets/drinks/smoothie-strawberry-delight.png?v=20260710',
        allergens: ['Coconut'], nutrition: { kj: 460, kcal: 110, fat: 0.4, satFat: 0.1, carbs: 27, sugars: 20, fibre: 5, protein: 1, sodium: 8 } },
      { name: 'Berry Blast',        ingr: 'strawberries, banana, apple, coconut water', price: 6.50, color: '#CA0039', img: 'assets/drinks/smoothie-berry-blast.png?v=20260710',
  ...
  },
  {
    ...
    items: [
      { name: 'Garden Green',      ingr: 'cucumber, celery, kale', price: 6.00, color: '#3E7A1E', img: 'assets/drinks/juice-garden-green.png?v=20260710',
        allergens: [], nutrition: { kj: 210, kcal: 50, fat: 0.3, satFat: 0, carbs: 11, sugars: 6, fibre: 2, protein: 2, sodium: 30 }, noAddedSugar: true },
      { name: 'Carrot Glow',       ingr: 'carrot, apple, ginger', price: 6.00, color: '#CA3D00', img: 'assets/drinks/juice-carrot-glow.png?v=20260710',
        allergens: [], nutrition: { kj: 460, kcal: 110, fat: 0.3, satFat: 0, carbs: 26, sugars: 20, fibre: 3, protein: 1, sodium: 35 }, noAddedSugar: true },
      { name: 'Sunrise Carrot',    ingr: 'carrot, orange, lemon', price: 6.00, color: '#CA3D00', img: 'assets/drinks/juice-sunrise-carrot.png?v=20260710',
        allergens: [], nutrition: { kj: 550, kcal: 130, fat: 0.3, satFat: 0, carbs: 31, sugars: 25, fibre: 4, protein: 2, sodium: 30 }, noAddedSugar: true },
      { name: 'Daily Cleanse',     ingr: 'apple, carrot, ginger', price: 6.00, color: '#3E7A1E', img: 'assets/drinks/juice-daily-cleanse.png?v=20260710',
        allergens: [], nutrition: { kj: 630, kcal: 150, fat: 0.4, satFat: 0, carbs: 37, sugars: 30, fibre: 4, protein: 1, sodium: 12 }, noAddedSugar: true },
      { name: 'Citrus Refresher',  ingr: 'apple, mint, ginger, lemon', price: 6.00, color: '#DF9A00', img: 'assets/drinks/juice-citrus-refresher.png?v=20260710',
        allergens: [], nutrition: { kj: 590, kcal: 140, fat: 0.3, satFat: 0, carbs: 35, sugars: 28, fibre: 3, protein: 0, sodium: 5 }, noAddedSugar: true },
      { name: 'Apple Zing',        ingr: 'apple, mint, ginger', price: 6.00, color: '#3E7A1E', img: 'assets/drinks/juice-apple-zing.png?v=20260710',
        allergens: [], nutrition: { kj: 590, kcal: 140, fat: 0.3, satFat: 0, carbs: 35, sugars: 28, fibre: 3, protein: 0, sodium: 5 }, noAddedSugar: true },
      { name: 'Citrus Boost',      ingr: 'orange, lemon, carrot', price: 6.00, color: '#DF9A00', img: 'assets/drinks/juice-citrus-boost.png?v=20260710',
        allergens: [], nutrition: { kj: 550, kcal: 130, fat: 0.3, satFat: 0, carbs: 31, sugars: 25, fibre: 4, protein: 2, sodium: 25 }, noAddedSugar: true },
      { name: 'Vitamin C Blast',   ingr: 'orange, pineapple, lemon', price: 6.00, color: '#DF9A00', img: 'assets/drinks/juice-vitamin-c-blast.png?v=20260710',
        allergens: [], nutrition: { kj: 710, kcal: 170, fat: 0.4, satFat: 0, carbs: 41, sugars: 35, fibre: 4, protein: 2, sodium: 8 }, noAddedSugar: true },
      { name: 'Berry Fresh',       ingr: 'strawberries, apple, lemon', price: 6.00, color: '#C1002F', img: 'assets/drinks/juice-berry-fresh.png?v=20260710',
  ...
  },
  {
    ...
    items: [
      { name: 'Chicken Mayo',      ingr: 'chicken breast, red onion, peppers, house mayo and chilli · served in sourdough bread',       price: 6.00, color: '#C9A227', img: 'assets/drinks/sandwich-chicken-mayo.png?v=2',
      ...
      { name: 'Tuna Crunch',       ingr: 'tuna, red onion, mixed peppers, sweet corn, house mayo and chilli · served in sourdough bread', price: 6.00, color: '#D98B2B', img: 'assets/drinks/sandwich-tuna-crunch.png?v=2',
      ...
      { name: 'Steak and Peppers', ingr: 'steak, mixed pepper, onion, house marinade · served in sourdough bread',                       price: 6.50, color: '#7A2E1E', img: 'assets/drinks/sandwich-steak-peppers.png?v=2',
