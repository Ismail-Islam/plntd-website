...
window.MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Plain Croissant',   ingr: 'butter, flour', price: 2.50, color: '#C68A3E', img: 'assets/drinks/bake-plain-croissant.png?v=3',
        allergens: ['Gluten', 'Milk', 'Egg'], nutrition: { kj: 1130, kcal: 270, fat: 14, satFat: 8, carbs: 30, sugars: 6, fibre: 1.5, protein: 5, sodium: 300 } },
      { name: 'Almond Croissant',  ingr: 'almond frangipane, flaked almonds', price: 3.20, color: '#B98A5E', img: 'assets/drinks/bake-almond-croissant.png?v=3',
      ...
      { name: 'Blueberry Muffin',  ingr: 'blueberries, vanilla', price: 2.80, color: '#3E5AA0', img: 'assets/drinks/bake-blueberry-muffin.png?v=3',
        allergens: ['Gluten', 'Milk', 'Egg'], nutrition: { kj: 1590, kcal: 380, fat: 16, satFat: 3, carbs: 54, sugars: 30, fibre: 2, protein: 5, sodium: 350 } },
      { name: 'Cinnamon Roll',     ingr: 'cinnamon, brown sugar, icing', price: 3.20, color: '#8B5A2B', img: 'assets/drinks/bake-cinnamon-roll.png?v=3',
