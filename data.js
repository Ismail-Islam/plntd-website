...
window.MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Carrot Glow',       ingr: 'carrot, apple, ginger', price: 6.00, color: '#CA3D00', img: 'assets/drinks/juice-carrot-glow.png?v=7',
        allergens: [], nutrition: { kj: 460, kcal: 110, fat: 0.3, satFat: 0, carbs: 26, sugars: 20, fibre: 3, protein: 1, sodium: 35 }, noAddedSugar: true },
      { name: 'Sunrise Carrot',    ingr: 'carrot, orange, lemon', price: 6.00, color: '#CA3D00', img: 'assets/drinks/juice-sunrise-carrot.png?v=7',
      ...
      { name: 'Apple Zing',        ingr: 'apple, mint, ginger', price: 6.00, color: '#3E7A1E', img: 'assets/drinks/juice-apple-zing.png?v=6',
        allergens: [], nutrition: { kj: 590, kcal: 140, fat: 0.3, satFat: 0, carbs: 35, sugars: 28, fibre: 3, protein: 0, sodium: 5 }, noAddedSugar: true },
      { name: 'Citrus Boost',      ingr: 'orange, lemon, carrot', price: 6.00, color: '#DF9A00', img: 'assets/drinks/juice-citrus-boost.png?v=7',
